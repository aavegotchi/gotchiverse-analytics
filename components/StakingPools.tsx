            ...
            <div className="wrapper">
                <div className = "bodyWrapper">
                    <div className = "left">
                        ...
                        <Image src = {`/static/images/chevron-left.png`} alt = "chevron" width = "50" height = "50" />
                        </button>
                    </div>
                        ...
                        <div className = "dataContainerv2">
                            <div className = "mainDatav2">
                                ...
                                <div className = "tileTitle_wrapper">
                                    <span className = "tileTitle">GLTR STAKING</span>
                                </div>
                            </div>
                    ...
                    <div className = "right">
                        ...
                        <Image src = {`/static/images/chevron-right.png`}  alt = "chevron" width = "50" height = "50" />
                        </button>
                    </div>
                </div>
