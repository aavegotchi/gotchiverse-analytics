            ...
            if (props.data) {
                if (props.data[page]?.totalSupply != null) {
                    setDataToBeDisplayed(
                        props.data[page].totalSupply > maxNumberLength
                            ? props.data[page].totalSupply.slice(
                                  0,
                                  maxNumberLength
                              )
                            : props.data[page].totalSupply
                    );
                    setSuffix(
                        props.data[page].totalSupply > maxNumberLength
                            ? props.data[page].totalSupply.length -
                                  maxNumberLength
                            : 0
                    );
                }
                ...
                <div className="wrapper">
                    <div className="bodyWrapper">
                        <div className="left">
                            ...
                            >
                                <Image
                                    src={`https://res.cloudinary.com/djev64cqn/image/upload/v1656148594/chevron-left_pozygn.png`}
                                    alt="chevron"
                                    width="60"
                                    height="60"
                                />
                        ...
                        <div className="center">
                            <div className="tileHeader">
                                <span className="tileHeader">Total Supply</span>
                            </div>
                        ...
                        <div className="right">
                            ...
                            >
                                <Image
                                    src={`https://res.cloudinary.com/djev64cqn/image/upload/v1656148601/chevron-right_qraw6n.png`}
                                    alt="chevron"
                                    width="60"
                                    height="60"
                                />
