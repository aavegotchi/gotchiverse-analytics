...
function ChartTest(props: ChartTestProps) : JSX.Element {
    const {title, data7d, data30d} = props;
    ...
    const [installationsMintedTotalWeek, setInstallationsMintedWeekTotal] = useState<string[]>([]); 
    const [installationsMintedTotalMonth, setInstallationsMintedMonthTotal] = useState<string[]>([]);


    //================ tiles minted =========================================
    const [tilesMintedTotalWeek, setTilesMintedWeekTotal] = useState<string[]>([]); 
    const [tilesMintedTotalMonth, setTilesMintedMonthTotal] = useState<string[]>([]);
    ...
    useEffect(() => {
        function createDataObject() {
            ...
            data7d.map((data, index) => {
                arrayInstallationsMintedWeekly[index] = data.data["installationsMintedTotal"]
            ...
            data30d.map((data, index) => {
                arrayInstallationsMintedMonthly[index] = data.data["installationsMintedTotal"]
            })
            ...
            <div className = "wrapper">
                ...
                <div className = "buttonWrapper">
                    <div className = "buttons">
                        <button className = "button" disabled = {display7d === true} onClick ={() => {
                            setDisplay7d(true);
                            
                        }}>7 d</button>
                        <button className = "button" disabled = {display7d === false}  onClick = {() => {
                            setDisplay7d(false);
                        }}>30 d</button>
                    </div>
