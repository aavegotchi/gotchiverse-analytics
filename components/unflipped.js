...
function UnflippedTile({ title, data, data1d, data7d, data30d }) {
    ...
    useEffect(() => {
        setDataToBeDisplayed(
            data.toString().length > 8 ? data.toString().slice(0, -18) : data
        );
    }, []);
...
function GraphExpanded({ expandedFunction }) {
        ...
        <>
            <div className="wrapper">
                ...
                <div className="buttonWrapper">
                    <div>
                        <button className="button" onClick={expandedFunction}>
                            BACK
                        </button>
                    </div>
                    <div>
